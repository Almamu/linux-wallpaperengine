...
TEST_CASE_METHOD (BackgroundListFixture, "Background list behaviour") {
	...
	= { { "3050", false }, { "5241", false }, { "9999", false }, { "100849", false } };

    std::map<std::string, bool> hasPreviews
	= { { "3050", true }, { "5241", true }, { "9999", true }, { "100849", false } };
    ...
    std::ranges::for_each (values, [] (auto& pair) -> void { REQUIRE (pair.second == true); });
